...
func Install() flow.Flow {
	...
	return flow.Flow{
		...
		Steps: []flow.Step{
			...
			newStep("extract", extract, removeDapp),
...
func InstallLinux() flow.Flow {
	return flow.Flow{
		...
		Steps: []flow.Step{
			...
			newStep("install", installContainer, removeContainer),
			newStep("start", startContainer, stopContainer),
...
func UpdateLinux() flow.Flow {
	return flow.Flow{
		...
		Steps: []flow.Step{
			...
			newStep("init temp", initTemp, removeTemp),
			newStep("stop", stopContainer, startContainer),
